...
<div>
    <h2>Projects: Ways to Make Marketing Smarter (MTA) </h2>
    <div>
        <h3> 1. Marketing Attribution Analysis</h3>
            <p> The Multi-Touch Attribution (MTA) model is a classic approach for evaluating the contribution of each channel to final sales. It assists marketing decision-makers in better allocating their resources, whether financial or personnel. Furthermore, the marketing team can calculate the return on investment (ROI) of their efforts by comparing the sales generated by each channel against the costs incurred.
            <p>There are several MTA (Multi-Touch Attribution) models, including First Touch, Last Touch, Time-Decay, Position-Based, U-Shaped, and Data-Driven, among others. Here, I am implementing one of the most popular attribution models, namely,<b>Time-Decay Attribition Model</b>.<br>
            <p><b>Time-Decay Attribition Model</b> usually use this following calculation as decay factor:<b>weight = 0.5<sup>(t/half-life)</sup></b>. In this model, <b>'t'</b> represents the time difference between a touchpoint and the final conversion. The <b>'half-life'</b> is typically set to 7, indicating that the influence on conversion is halved every seven days.<br>
            <p><a href="Exponential_Time_Decay_Attribution_Model.md">Click here to see how I run Exponential Time-Decay Attribution Model step by step in Python</a>
    </div>
    <div>
